...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Track your daily habits and build streaks that stick.'**
  ...
  /// No description provided for @addHabitButtonLabel.
  ///
  /// In en, this message translates to:
  /// **'Add a new habit'**
  String get addHabitButtonLabel;
